...
public class Calculator {
     ...
     * Für den Fall, dass eine Inversion von 0 versucht wird, gibt die Methode "Error" auf dem Taschenrechner aus.
    ...
    public void pressUnaryOperationKey(String operation) {
        ...
        //Bugfix für den ersten Test aus Teilaufgabe 2
        double value = Double.parseDouble(screen);
        //Wenn die Operation "1/x" aufgerufen wird und der Variablenwert 0 ist...
        if (operation.equals("1/x") && value == 0) {
            screen = "Error"; //Error anzeigen
            return; //Methode vorzeitig beenden
        }
