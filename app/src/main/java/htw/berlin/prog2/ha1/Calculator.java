...
public class Calculator {
     ...
     * Sollte vor der Operation schon eine Operation in der Rechnung gemacht worden sein, dann wird ein Zwischenergebnis
     * errechnet, damit keine Operation überschrieben wird.
